...
class ProductsForm extends React.Component{
    ...
    getProductList = () => {
        fetch('http://solucionesoggk.com/api/v1/product_list_categorized', {
            method: 'GET',
            headers: {
        ...
        return(
            <React.Fragment>
                ...
                <Divider style={{ backgroundColor: 'grey', height:2, marginTop:10}} />
                    ...
                    <View style={{flex: 1, flexDirection: 'row', marginBottom:2, marginTop:10}}>
                        <View style={{flex:1.5,width: 100, height: 20}}>
                            <Text style={{color:'grey',fontWeight: 'bold'}}>{this.state.sub_total.toPrecision(4)}</Text>
                         </View> 
                        <View style={{flex:1.5,width: 100, height: 20}}>
                            <Text style={{color:'grey',fontWeight: 'bold'}}>{this.state.igv.toPrecision(4)}</Text>
                         </View> 
                        <View style={{flex:1.5,width: 100, height: 20, backgroundColor: 'white'}}>
                            <Text style={{color:'grey',fontWeight: 'bold'}}>{this.state.total.toPrecision(4)}</Text>
                        </View>
                        <View style={{flex:1.5,width: 100, height: 20, backgroundColor: 'white'}}>
